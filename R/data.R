...
#' Plasmodium falciparum parasite rate in 2-10 year olds in 2000-2017 in Central Africa
#'
...
#'
#' A SpatialPolygonsDataFrame for Central Africa
#'
#' @format A SpatialPolygonsDataFrame with dimensions 14 and 16
#' \describe{
